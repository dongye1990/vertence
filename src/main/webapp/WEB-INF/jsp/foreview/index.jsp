...
<body style="min-width:1200px;">
   <div class="header header-min">
      ...
      <div class="banner">
         <ul class="banner-imgwrap clearfix">
             <li class="present">
               <img src="static/images/vt_2017081001.jpg">
   ...
   <div class="container">
      <div class="vt_video" id="vt_video">
         ...
         <div class="vt-right fl">
            <div class="vtr_h3" id="vtr_title">小型饲料机械及工程解决方案</div>
            <p id="vtr_content">提供300KG/H-5T/H试产小型饲料生产行业种类齐全、技术水准高的全面解决方案，可为客户提供从单台饲料加工机械设备、到整套饲料生产线、到新建饲料厂的多层次全方位解决方案。例如对于新建饲料厂客户，整体解决方案包括：整体设计、厂房、钢板仓、输送设备、饲料机械设备、电控系统等，为用户提供优质的、最贴心的"交钥匙"工程服务。</p>
         </div>
   ...
   <div class="right-nav">
   		<a class="rn-email" title="email" href="mail" target="_blank">
