...
<body>
	...
	<div class="page">
		...
		<div id="rev_slider_5_1_wrapper"
			class="rev_slider_wrapper fullwidthbanner-container slide-overlay"
			...
			<div id="rev_slider_5_1" class="rev_slider fullwidthabanner"
				...
				<ul>
					<!-- SLIDE  -->
					<li data-index="rs-7" data-transition="fade" data-slotamount="1"
						data-easein="default" data-easeout="default"
						data-masterspeed="1500" data-rotate="0" data-saveperformance="off"
						data-title="Slide" data-param1="" data-param2="" data-param3=""
						data-param4="" data-param5="" data-param6="" data-param7=""
						data-param8="" data-param9="" data-param10="" data-description="">

						<!-- MAIN IMAGE --> <img
						src="${ctx}/static/fixfellow/images/slides/slider-mainbg-006.jpg"
						alt="" data-bgposition="center center" data-bgfit="cover"
						data-bgrepeat="no-repeat" class="rev-slidebg" data-no-retina>
						<!-- LAYERS --> <!-- LAYER NR. 3 -->
						<div
							class="tp-caption rev-shape ttm-bgcolor-skincolor tp-resizeme"
							id="slide-7-layer-3" data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['151','151','80','-100']"
							...
							data-paddingtop="[13,13,10,10]" data-paddingright="[22,22,22,10]"
							data-paddingbottom="[11,11,10,10]"
							data-paddingleft="[22,22,22,10]" data-type="text"
							data-responsive_offset="on">Why Sinova?</div> <!-- LAYER NR. 4-->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-4"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['210','219','140','-45']"
							...
							data-type="text" data-responsive_offset="on">High Quality</div> <!-- LAYER NR. 5 -->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-5"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['240','286','199','0']"
							data-fontsize="['20','20','18','16']"
							data-lineheight="['52','52','48','38']"
							data-fontweight="['600','600','600','600']"
							...
							data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
							data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							data-type="text" data-responsive_offset="on">Customized
							Design</div> <!-- LAYER NR. 4-->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-4"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['270','219','140','-45']"
							data-fontsize="['20','20','18','16']"
							data-lineheight="['52','52','48','38']"
							data-fontweight="['600','600','600','600']"
							data-color="['rgba(10, 28, 55,1)','rgba(10, 28, 55,1)','rgba(10, 28, 55,1)','rgba(10, 28, 55,1)']"
							...
							data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
							data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							data-type="text" data-responsive_offset="on">Less Lead Time
						</div> <!-- LAYER NR. 5 -->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-5"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['300','286','199','0']"
							data-fontsize="['20','20','18','16']"
							data-lineheight="['52','52','48','38']"
							data-fontweight="['600','600','600','600']"
							data-color="['rgba(255, 210, 0,1)','rgba(255, 210, 0,1)','rgba(255, 210, 0,1)','rgba(255, 210, 0,1)']"
							...
							data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
							data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							data-type="text" data-responsive_offset="on">Door-to-door
							Service Available</div> <!-- LAYER NR. 4-->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-4"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['330','219','140','-45']"
							data-fontsize="['20','20','18','16']"
							data-lineheight="['52','52','48','38']"
							data-fontweight="['600','600','600','600']"
							data-color="['rgba(10, 28, 55,1)','rgba(10, 28, 55,1)','rgba(10, 28, 55,1)','rgba(10, 28, 55,1)']"
							...
							data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
							data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							data-type="text" data-responsive_offset="on">Flexible
							Payment Term Available</div> <!-- LAYER NR. 5 -->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-5"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['360','286','199','0']"
							data-fontsize="['20','20','18','16']"
							data-lineheight="['52','52','48','38']"
							data-fontweight="['600','600','600','600']"
							data-color="['rgba(255, 210, 0,1)','rgba(255, 210, 0,1)','rgba(255, 210, 0,1)','rgba(255, 210, 0,1)']"
							...
							data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
							data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							data-type="text" data-responsive_offset="on">Local
							Establishment</div> <!-- LAYER NR. 4-->
						<div class="tp-caption tp-resizeme" id="slide-7-layer-4"
							data-x="['left','left','left','left']"
							data-hoffset="['50','40','30','30']"
							data-y="['top','top','top','middle']"
							data-voffset="['390','219','140','-45']"
							data-fontsize="['20','20','18','16']"
							data-lineheight="['52','52','48','38']"
							data-fontweight="['600','600','600','600']"
							data-color="['rgba(10, 28, 55,1)','rgba(10, 28, 55,1)','rgba(10, 28, 55,1)','rgba(10, 28, 55,1)']"
							...
							data-paddingtop="[0,0,0,0]" data-paddingright="[0,0,0,0]"
							data-paddingbottom="[0,0,0,0]" data-paddingleft="[0,0,0,0]"
							data-type="text" data-responsive_offset="on">One-stop
							Solution</div>
									...
									<div class="products row">
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/10.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
									...
									<div class="products row">
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/23.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
									...
									<div class="products row">
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/25.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/26.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/27.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/28.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
									...
									<div class="products row">
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/30.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/31.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
										...
										<div class="product col-md-3 col-sm-6 col-xs-12">
											<div class="product-box">
												...
												<div class="product-box-inner">
													<div class="product-image-box">
														<img src="${ctx}/static/fixfellow/images/pdt/32.png"
															alt="">
													</div>
												</div>
												<!-- product-box-inner end -->
