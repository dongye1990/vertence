                        ...
                        <article class="post ttm-blog-classic clearfix">
                            ...
                            <div class="ttm-blog-classic-content">
                                <div class="ttm-post-entry-header">
                                    <div class="post-meta">
                                        <span class="post-meta-line"><a href="#" tabindex="0"><i class="fa fa-calendar"></i>January 16, 2019</a></span>
                                    </div>
                                    <div class="post-meta">
                                ...
                                <div class="entry-content">
                                    ...
                                    <div class="mt-30">
                                        <img class="img-fluid alignleft" src="images/single-img-two.jpg" alt="">
                                        ...
                                        <ul class="ttm-list ttm-list-style-icon ttm-list-icon-color-skincolor pt-5">
                                            <li><i class="fa fa-check"></i><span class="ttm-list-li-content">Quisque aliquet nibh sit amet lectus auctor.</span></li>
                                            <li><i class="fa fa-check"></i><span class="ttm-list-li-content">Nulla at metus ultricies, placerat augue sed.</span></li>
                                            <li><i class="fa fa-check"></i><span class="ttm-list-li-content">Curabitur mollis ex vestibulum, ullamcorper.</span></li>
                                            <li><i class="fa fa-check"></i><span class="ttm-list-li-content">Quisque aliquet nibh sit amet lectus aucto.</span></li>
                                        </ul>
                                    </div>
                                    <div class="mt-30">
