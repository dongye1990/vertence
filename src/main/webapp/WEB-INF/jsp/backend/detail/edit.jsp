	...
	<c:if test="${index==1}">
	 ...
	 <div class="page-content">
		<div class="page-header">
			<h1>
				详情页管理 <small> <i class="icon-double-angle-right"></i>
				<c:if test="${index==0}">
					详情页新增
				</c:if>
				<c:if test="${index==1}">
		...
		<div class="row">
			<div class="col-xs-12">
				<form class="form-horizontal" role="form" id="formId">
					...
					<input type="hidden" name="content" id="content" value='${detail.content}'>
					<div class="space-4"></div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
							for="form-field-2"> 详情页id： </label>
						<div class="col-sm-9">
							<input type="text" id="form-field-2" name="detailid" placeholder="请输入详情页id" value="${detail.detailid}" class="col-xs-10 col-sm-10" /> 
						</div>
					</div>
					<div class="form-group">
						<label class="col-sm-2 control-label no-padding-right"
